...
public abstract class Controller {
    ...
    protected static final JFrame mainFrame =
            new JFrame();

    private static final JPanel viewsViewer =
    ...
    public static final void addView(
            String viewName,
            View view) {
    ...
    public static final void loadView(
            String viewName) {

        CardLayout cl =
                (CardLayout)
                        viewsViewer.getLayout();
    ...
    public static final void addComponent(
        ...
        mainFrameComponents.put(
                name,
                component);
    }

    public static final void removeComponent(
            String name) {
